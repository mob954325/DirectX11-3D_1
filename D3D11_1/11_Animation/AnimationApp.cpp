...
bool AnimationApp::OnInitialize()
{
	if (!InitD3D())
		return false;
...
LRESULT AnimationApp::WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
