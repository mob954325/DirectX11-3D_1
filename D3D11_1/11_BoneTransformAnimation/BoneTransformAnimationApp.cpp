...
BoneTransformAnimationApp::BoneTransformAnimationApp(HINSTANCE hInstance)
	: GameApp(hInstance)
{

}

BoneTransformAnimationApp::~BoneTransformAnimationApp()
{
	UninitImGUI();
}

bool BoneTransformAnimationApp::OnInitialize()
{
	if (!InitD3D())
		return false;
...
bool BoneTransformAnimationApp::InitImGUI()
{
...
void BoneTransformAnimationApp::UninitImGUI()
{
	// Cleanup
...
bool BoneTransformAnimationApp::InitD3D()
{
	HRESULT hr = S_OK;
...
bool BoneTransformAnimationApp::InitScene()
{
	HRESULT hr = S_OK;
...
bool BoneTransformAnimationApp::InitEffect()
{
...
LRESULT BoneTransformAnimationApp::WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
