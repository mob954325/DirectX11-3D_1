...
BVHCullingApp::BVHCullingApp(HINSTANCE hInstance)
	: GameApp(hInstance)
{

}

BVHCullingApp::~BVHCullingApp()
{
	UninitImGUI();
}

void BVHCullingApp::InitDebugDraw()
{
...
void BVHCullingApp::InitShdowMap()
{
...
void BVHCullingApp::DebugDrawFrustum(Matrix worldMat, Matrix viewMat, Matrix proejctionMat,
...
bool BVHCullingApp::OnInitialize()
{
	if (!InitD3D())
		return false;
...
void BVHCullingApp::DepthOnlyPass()
{
	// 바인딩 해제
...
void BVHCullingApp::RenderImGUI()
{
	...
	ImGui::Begin("ShadowMap");
	{
		...
		ImGui::Text("ShadowView");
		ShowMatrix(m_shadowView, "m_shadowView");
		ImGui::Spacing();

		ImGui::Text("ShadowProj");
		ShowMatrix(m_shadowProj, "m_shadowProj");
	}
...
void BVHCullingApp::UninitImGUI()
{
	// Cleanup
...
void BVHCullingApp::ResetValues()
{
	m_Near = 0.01f;
	m_Far = 3000.0f;
...
void BVHCullingApp::ShowMatrix(const DirectX::XMFLOAT4X4& mat, const char* label)
{
	// 각 행을 출력
...
LRESULT BVHCullingApp::WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
