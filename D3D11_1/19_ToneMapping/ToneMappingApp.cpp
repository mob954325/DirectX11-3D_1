...
ToneMappingApp::ToneMappingApp(HINSTANCE hInstance)
	: GameApp(hInstance)
{

}

ToneMappingApp::~ToneMappingApp()
{
	UninitImGUI();
}

void ToneMappingApp::InitDebugDraw()
{
...
void ToneMappingApp::InitShdowMap()
{
...
bool ToneMappingApp::InitSkyBox()
{
...
void ToneMappingApp::CreateHDRRenderTargetView()
{
...
void ToneMappingApp::CreateQuad()
{
...
void ToneMappingApp::DepthOnlyPass()
{
	// 바인딩 해제
...
void ToneMappingApp::DrawQuadPass()
{
	m_pDeviceContext->RSSetViewports(1, &m_RenderViewport); // 뷰포트 되돌리기
...
void ToneMappingApp::UninitImGUI()
{
	// Cleanup
...
bool ToneMappingApp::InitEffect()
{
...
void ToneMappingApp::ResetValues()
{
	m_Near = 0.01f;
	m_Far = 3000.0f;
...
void ToneMappingApp::ShowMatrix(const DirectX::XMFLOAT4X4& mat, const char* label)
{
	// 각 행을 출력
...
LRESULT ToneMappingApp::WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
...
void ToneMappingApp::OnInputProcess(const Keyboard::State& KeyState, const Keyboard::KeyboardStateTracker& KeyTracker, const Mouse::State& MouseState, const Mouse::ButtonStateTracker& MouseTracker)
{
