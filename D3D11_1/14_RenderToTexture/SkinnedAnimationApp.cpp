...
SkinnedAnimationApp::SkinnedAnimationApp(HINSTANCE hInstance)
	: GameApp(hInstance)
{

}

SkinnedAnimationApp::~SkinnedAnimationApp()
{
	UninitImGUI();
}

void SkinnedAnimationApp::RenderTextureInit()
{
	...
	// RTT 생성
	HR_T(m_pDevice->CreateTexture2D(&textureDesc, NULL, &m_pRenderTargetTexture));

	renderTargetViewDesc.Format = textureDesc.Format;
	renderTargetViewDesc.ViewDimension = D3D11_RTV_DIMENSION_TEXTURE2D; // ??
	renderTargetViewDesc.Texture2D.MipSlice = 0;

	HR_T(m_pDevice->CreateRenderTargetView(m_pRenderTargetTexture.Get(), &renderTargetViewDesc, m_pRenderTargetView_RTT.GetAddressOf()));
...
void SkinnedAnimationApp::OnUpdate()
{
...
void SkinnedAnimationApp::OnRender()
{
	...
	m_pDeviceContext->OMSetRenderTargets(1, m_pRenderTargetView_RTT.GetAddressOf(), m_pDepthStencilView.Get()); // render target을 텍스처로 -> TODO : 텍스처 vs에 받아서 띄우면됨

	// m_pDeviceContext->VSSetShaderResources(0, 1, m_pShaderResourceView_RTT.GetAddressOf());
...
bool SkinnedAnimationApp::InitImGUI()
{
...
void SkinnedAnimationApp::RenderImGUI()
{
...
void SkinnedAnimationApp::UninitImGUI()
{
	// Cleanup
...
bool SkinnedAnimationApp::InitD3D()
{
	HRESULT hr = S_OK;
...
bool SkinnedAnimationApp::InitScene()
{
	HRESULT hr = S_OK;
...
bool SkinnedAnimationApp::InitEffect()
{
...
LRESULT SkinnedAnimationApp::WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
