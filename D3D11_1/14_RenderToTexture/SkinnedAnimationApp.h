...
public:
	...
	// RenderToTexture
	ComPtr<ID3D11Texture2D> m_pRenderTargetTexture;				// 이게 결과?
	ComPtr<ID3D11RenderTargetView>	m_pRenderTargetView_RTT = nullptr;	// RTT를 위한 랜더 타겟 - 임시
	ComPtr<ID3D11ShaderResourceView> m_pShaderResourceView_RTT;		// ??
	ComPtr<ID3D11Buffer> m_pVertexBuffer_RTT;
