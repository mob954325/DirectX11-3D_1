...
PhongShadingApp::~PhongShadingApp()
{
	UninitImGUI();
}
...
bool PhongShadingApp::InitImGUI()
{
...
void PhongShadingApp::RenderImGUI()
{
...
void PhongShadingApp::UninitImGUI()
{
	// Cleanup
...
bool PhongShadingApp::InitScene()
{
	HRESULT hr = S_OK;
...
void PhongShadingApp::ResetValues()
{
...
LRESULT PhongShadingApp::WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
